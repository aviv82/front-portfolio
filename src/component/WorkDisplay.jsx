...
*/
  ...
  const imageToDisplay = `${ORIGIN}${workToDisplay[0].attributes.media.data.attributes.formats.large.url}`;
  // console.log("pic url", imageToDisplay);

  return (
    <div className="display-wrap">
      <h1 className="display-title">{workToDisplay[0].attributes.title}</h1>
      <h3 className="display-genre">{workToDisplay[0].attributes.type}</h3>
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
